...
const resourcing = {
  ...
  "Emotional numbing": {
    ...
    holdsInternal: "You're not the child who first turned it down — you let smaller things in before and stayed standing. Feelings crest and pass when you let them; you've felt that happen already.",
...
function renderResourcing(b) {
  ...
  return `
    <div class="resourcing" role="region" aria-label="Resourcing layer for ${b.name}">
      ...
      <div class="r-rail">
        <div class="r-block">
          <strong class="r-label">What if it comes true</strong>
          <p>${entry.whatIfItComesTrue}</p>
        </div>
        <div class="r-block r-internal">
          <strong class="r-label">What holds — inside you</strong>
          <p>${entry.holdsInternal}</p>
        </div>
        <div class="r-block r-external">
          <strong class="r-label">What holds — with another person</strong>
          <p>${entry.holdsExternal}</p>
        </div>
        <div class="r-block r-move">
          <strong class="r-label">One move</strong>
          <p>${entry.move}</p>
        </div>
      </div>
    </div>
 ...
 * "no one is monitoring this page" — honest because it's true.
